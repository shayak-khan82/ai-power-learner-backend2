 ...
 * @param {string} text -Docment text
 ...
 * @param {string} text - Document tex
 * @returns {Promise<string}
 */

export const generateSummary = async(text) => {
    const prompt = `Provide a concise sumary of the following text,highlighting the key concepts, main ideas and important points.
