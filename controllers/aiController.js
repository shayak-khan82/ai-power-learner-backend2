...
//             return res.status(404).json({
//                 success:false,
//                 error:'Dcument not found or not ready',
//                 statusCode: 404
//             })
//         }
...
//             },
//             message:'Respone generated successfully'
//         })
//     } catch (error) {
//         next(error)
//     }
...
//@desc get chat histroy for a document
    ...
    try {
        ...
        if(!chatHistory){
            return res.status(200).json({
                success:true,
                data:[],
                message:'No chat history found for this docment'
            })
        }
